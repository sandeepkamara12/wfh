                            ...
                            <div className="text-center">
                                ...
                                <div class="mt-7">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <button class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded bg-white border border-gray-400 text-layer-foreground shadow-2xs hover:bg-layer-hover disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-layer-focus">
                                    ...
                                    <div class="pt-8 pb-7 flex items-center text-sm text-muted-foreground uppercase font-medium before:flex-1 before:border-t before:border-gray-400 before:me-6 after:flex-1 after:border-t after:border-gray-400 after:ms-6">Or</div>
                                </div>
                            </div>
