            ...
            <>
                <div className="grid grid-cols-2 h-full">
                    <div className="flex flex-wrap items-center justify-center">
                        <div className="p-4 sm:p-7 max-w-xl mx-auto w-3/6">
                            <div className="text-center">
                                <img src="/public/wfh-logo.png" alt="logo" width="100" height="auto" className='mx-auto block mb-6' />
                                <h3 id="hs-modal-signin-label" className="block text-2xl font-bold text-foreground">Sign in to <span className='text-orange'>WFH</span></h3>
                                ...
                                <div className="mt-7">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <button className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded bg-white border border-gray-400 text-layer-foreground shadow-2xs hover:bg-layer-hover disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-layer-focus">
                                    ...
                                    <div className="pt-8 pb-7 flex items-center text-sm text-muted-foreground uppercase font-medium before:flex-1 before:border-t before:border-gray-400 before:me-6 after:flex-1 after:border-t after:border-gray-400 after:ms-6">Or</div>
                                </div>
                            </div>
                            ...
                            <form className="flex flex-col gap-4" onSubmit={formik.handleSubmit}>
                                ...
                                <div className='flex flex-wrap items-center justify-between'>
                                    <label className="flex items-center gap-2 cursor-pointer select-none">
                                        ...
                                        <div
                                            className={`w-4 h-4 flex items-center justify-center rounded border-2 transition-all
        ${checked
                                    ...
                                    <Link className='text-sm font-medium text-orange no-underline hover:text-navy transition-all duration-200 ease-in-out' to="/forgot-password">Forgot Password?</Link>
                                </div>
                                <button type="submit" className="btn" disabled={loading || !(formik.isValid && formik.dirty)}>{loading ? "Signing in..." : "Sign in"}</button>
                                <p className="text-sm text-navy font-medium text-center">
                                    Don't have an account?
                                    <a className="ms-1 text-orange no-underline focus:outline-hidden focus:underline font-medium hover:text-navy transition-all duration-200 ease-in-out" href="#">
                                        Sign Up
                                    </a>
                                </p>
                            </form>
