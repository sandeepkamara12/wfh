    ...
    return (
        <>
            ...
            <div className={`modal-wrapper ${(open != 'teacher' && open != 'student' && open !== null) ? '' : 'opacity-0 invisible'}`} role="dialog" tabIndex="-1" aria-labelledby="hs-basic-modal-label">
                <div className={`${(open != 'teacher' && open != 'student' && open !== null) ? 'mb-7 opacity-100 duration-500' : 'mb-0 opacity-0'} flex items-end ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto`}>
