    ...
    return (
        <>
            ...
            <div className={`grid grid-cols-2 ${alignment} gap-2`}>
                ...
                <RadioCard className="gender-field" icon={<Venus className="shrink-0 size-5" />} text="Female" group="gender" formik={formik} id="female" error={formik.touched.gender && formik.errors.gender} />
            </div>
        </>
    )
}
