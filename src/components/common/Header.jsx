const Header = () => {
    return (
        <div>
            <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-48 w-full bg-white border-b border-[#ebe6e7] text-sm py-2.5 lg:ps-65">
                    ...
                    <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
                        <div className="hidden md:block">
                            ...
                            <div className="relative">
                                ...
                                <input type="text" className="py-2 ps-10 pe-16 block w-full bg-layer border border-[#ebe6e7] rounded-lg text-sm text-foreground placeholder:text-[#fbf9fa]-foreground focus:outline-hidden focus:border-primary-focus focus:ring-primary-focus disabled:opacity-50 disabled:pointer-events-none" placeholder="Search" />
                        ...
                        <div className="flex flex-row items-center justify-end gap-1">
                            <button type="button" className="md:hidden size-9.5 relative inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-foreground hover:bg-[#fbf9fa]-hover focus:outline-hidden focus:bg-[#fbf9fa]-focus disabled:opacity-50 disabled:pointer-events-none">
                            ...
                            <button type="button" className="size-9.5 relative inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-foreground hover:bg-[#fbf9fa]-hover focus:outline-hidden focus:bg-[#fbf9fa]-focus disabled:opacity-50 disabled:pointer-events-none">
