        ...
        <div className='w-full'>
            <div className='flex flex-wrap items-center gap-2'>
                <span className="inline-block size-20 bg-white rounded-full relative group">
                         <button type="button" className="-right-1 absolute btn icon_btn_small text-gray-400  rounded-full bg-white border-none z-50 hover:text-red-400" onClick={removeImageHandler}>
                            <Trash2 className='own-icon' />
                        </button>
                    <span className="inline-flex flex-wrap items-center justify-center border border-gray-200 size-20 rounded-full overflow-hidden relative z-40" onClick={handleImageUploadTrigger}>
                        <input
                            type="file"
                            ref={fileRef}
                            accept="image/*"
