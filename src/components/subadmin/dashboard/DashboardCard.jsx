...
const DashboardCard = ({ label, count, id, link, onPlusClick }) => {
    ...
    return (
        <div className="flex flex-wrap items-end justify-between bg-white border border-gray-200 rounded p-4 3xl:p-5 transition-all duration-300 ease-in-out relative overflow-hidden">
