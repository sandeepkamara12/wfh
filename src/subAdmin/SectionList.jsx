      ...
      <div className="flex flex-col">
        <div className="overflow-x-auto [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-thumb]:rounded-none [&::-webkit-scrollbar-track]:bg-scrollbar-track [&::-webkit-scrollbar-thumb]:bg-scrollbar-thumb">
          <div className="min-w-full inline-block align-middle">
            <div className="">
              <Table id="sections" columns={columns} data={sectionData} btnText="Add Section" btnIcon={<LayoutGrid className="w-5 h-5 mx-auto" />} label="Sections" subLabel="Add Section, edit and more." />
            </div>
          </div>
        </div>
      </div>
